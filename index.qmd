...
tibble::tibble(Category = c("Intervention", "Assessment*", "Support*", "Supervision*"),
  ...
  knitr::kable(caption = "*Additional hours accrued and documented from supervised research Structured Clinical Interviews for DSM-5 at Center for Healthy Minds")
```  
